...
document.addEventListener("DOMContentLoaded", function () {
  ...
  feedbackForm.addEventListener("submit", function (event) {
    ...
    if (validateForm()) {
      ...
      message.textContent =
        'Thank you for trying out my feedback form! Currently, this function is not active as it is for demonstration purposes. In 30 seconds, you will be redirected back to the game. Alternatively, you can click anywhere on the page, or press "Enter" to return to the action.';
